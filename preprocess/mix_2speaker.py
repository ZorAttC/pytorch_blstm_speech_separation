...
cvNum=20
ttNum=10
file1 = "D:\\githubProjects\\pytorch_blstm_speech_separation\\S0010"
file2 = "D:\\githubProjects\\pytorch_blstm_speech_separation\\S0252_mic"
file_s1 = "D:\\githubProjects\\pytorch_blstm_speech_separation\\data\\wav\\tr\\s1\\"
file_s2 = "D:\\githubProjects\\pytorch_blstm_speech_separation\\data\\wav\\tr\\s2\\"
fileout="D:\\githubProjects\\pytorch_blstm_speech_separation\\data\\wav\\tr\\mix"
...
def delete_files_in_folder(folder_path):
    ...
    print("所有文件已删除")
def mix_2speaker(file1,file2,outpath,file_s1,file_s2):#pad each signal to the longer one and mix them
    ...
    fileout=os.path.join(outpath,os.path.basename(file1)[:-4]+"_"+os.path.basename(file2)[:-4]+".wav")
